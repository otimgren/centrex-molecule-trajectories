...
from .beamline_elements.apertures import BeamlineElement
from .molecule import Molecule, Trajectory
from .trajectory_simulator import Counter, SimulationResult


def import_element_from_hdf(
    element_name: str, filepath: Path, run_name: str
) -> BeamlineElement:
    """
...
def import_trajectories_from_hdf(
    filepath: Path, run_name: str, group_name: str = "trajectories"
) -> List[Molecule]:
    """
...
def import_distribution_from_hdf(
    dist_name: str, filepath: Path, run_name: str
) -> BeamlineElement:
    """
